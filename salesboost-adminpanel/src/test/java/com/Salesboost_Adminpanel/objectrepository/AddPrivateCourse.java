...
public class AddPrivateCourse extends BaseClass{
	...
	@FindBy (xpath ="//input[@id='Course_IsPrivate']") public WebElement coursePrivate;
	
	public AddPrivateCourse(WebDriver driver) {
		this.driver = driver;
		PageFactory.initElements(this.driver, this);
	}
	
	public void addCourse(String name,String sName,String slug,String list,String desc) {
		try {
